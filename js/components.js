    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
      ...
      <div>
        ...
        <ul class="list-none m-0 p-0 flex flex-col gap-3">
          ...
          <li><a href="/shop.html?category=padel" class="text-sm text-white/45 hover:text-rose transition-colors font-light no-underline">Padel</a></li>
          <li><a href="/shop.html?category=pilates" class="text-sm text-white/45 hover:text-rose transition-colors font-light no-underline">Pilates</a></li>
          <li><a href="/shop.html?category=tennis" class="text-sm text-white/45 hover:text-rose transition-colors font-light no-underline">Tennis</a></li>
          <li><a href="/shop.html?category=training" class="text-sm text-white/45 hover:text-rose transition-colors font-light no-underline">Training</a></li>
          <li><a href="/shop.html?category=running" class="text-sm text-white/45 hover:text-rose transition-colors font-light no-underline">Running</a></li>
        </ul>
      </div>
